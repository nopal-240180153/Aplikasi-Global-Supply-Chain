                    ...
                    <form action="{{ route('admin.ports.update', $port) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="port_code" name="port_code" value="{{ old('port_code', $port->port_code) }}">
                            </div>
                            <div class="col-md-6">
                                <label for="city" class="form-label fw-bold">Kota</label>
                                <input type="text" class="form-control" id="city" name="city" value="{{ old('city', $port->city) }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" step="any" class="form-control" id="latitude" name="latitude" value="{{ old('latitude', $port->latitude) }}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="longitude" class="form-label fw-bold">Longitude <span class="text-danger">*</span></label>
                                <input type="number" step="any" class="form-control" id="longitude" name="longitude" value="{{ old('longitude', $port->longitude) }}" required>
                            </div>
                        </div>

                        <div class="mb-4">
                            <label for="type" class="form-label fw-bold">Tipe Pelabuhan</label>
                            <input type="text" class="form-control" id="type" name="type" value="{{ old('type', $port->type) }}">
                        </div>
